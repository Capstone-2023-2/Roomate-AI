...
if __name__ == '__main__':
    ...
    print(main({"userId":"ex2","bedtimeScore":3,"wakeupScore":3,"wakeupSensitivity":2,"cleaningScore":2,"cleaningSensitivity":2,"foodScore":2,"foodSensitivity":3,"cigaretteScore":3,"studyScore":2,"studySensitivity":2,"notebookScore":2,"notebookSensitivity":1,"alarmScore":1,"alarmSensitivity":2,"latestudyScore":2,"latestudySensitivity":1,"snoringScore":1,"snoringSensitivity":2,"friendlyScore":1,"inhomeScore":2,"inhomeSensitivity":2,"coldOrHot":1,"summerOrWinter":1}, "man_308_dataset.json"))
